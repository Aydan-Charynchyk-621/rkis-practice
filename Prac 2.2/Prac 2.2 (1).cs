...
public class Program
{
    public class Student
    {
        ...
        public void Info()
        {
            ...
            foreach(int grades in progress)
    ...
    static void Main()
    {
        Student myInfo = new Student("Khertek", new DateTime(1991, 01, 30, 11, 30, 0), 714, new int [5] {4, 3, 4, 5, 2});

        myInfo.Changeinfo(surname: "Charynchyk", dateOfBirth: new DateTime(2004, 11, 27, 3, 0, 0), group: 621);
        myInfo.Info();
    }
}
